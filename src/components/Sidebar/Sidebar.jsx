const Sidebar = ({selectedCourse, totalCredit, totalPrice}) => {
  return (
    <div className="lg:w-[30%] xl:w-[20%] md:w-[40%] mb-5 ">
        <div className="bg-white p-3 rounded-lg">
          <h1 className="text-lg text-center font-semibold px-4 border-b-2 p-2  mx-auto text-[#2F80ED]">Credit Hour Remaining 7 hr</h1>
